...
import sty from "./PlasmicHeader3.module.css"; // plasmic-import: xeDZQCvAAvtAGS/css
...
function PlasmicHeader3__RenderFunc(props) {
  ...
  return true ? (
    ...
    >
      ...
      <LogoWhitesvgIcon
        className={classNames(projectcss.all, sty.svg__mNp8F)}
        role={"img"}
      />
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__iX1Z7)}
        >
          <a
            className={classNames(
              projectcss.all,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fzC7U)}
      >
        <IconLink
          ...
          icon={
            <React.Fragment>
              <IconIcon
                className={classNames(projectcss.all, sty.svg__i6ReE)}
                role={"img"}
              />
