...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: lItlBqPfSO9Gym/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__imQ1F, {
            [sty.freeBoxlong__imQ1F5Kvw]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__goJK)}
                displayHeight={"auto"}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___9NaYa, {
          [sty.freeBoxlong___9NaYa5Kvw]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
