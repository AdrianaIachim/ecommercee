...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: nWbDFCoLl4S-Ni/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__vPhZw)}
              role={"img"}
            />
          ),
