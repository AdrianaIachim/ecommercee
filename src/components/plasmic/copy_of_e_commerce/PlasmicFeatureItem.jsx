...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: sf4sLGw2KH3oJj/css
...
function PlasmicFeatureItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__tOi8B)}>
        <div className={classNames(projectcss.all, sty.freeBox__rBmH)} />
        <div className={classNames(projectcss.all, sty.freeBox__kdNPf)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___1B6Vu)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___5GfRy)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___9JNav)}
            >
              <LinkButton
