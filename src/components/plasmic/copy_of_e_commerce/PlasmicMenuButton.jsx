...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: ZLul_XgOIZkrwu/css
import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: dYlXYM-gblLxG-/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: v3G0oYmWj2pocj/icon
    ...
    >
      ...
      >
        {(hasVariant($state, "expanded", "expanded") ? true : true) ? (
          <BarsIcon
            className={classNames(projectcss.all, sty.svg__mrWpi, {
              [sty.svgexpanded__mrWpiNb1EE]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant($state, "expanded", "expanded") ? true : true) ? (
          <TimesIcon
            className={classNames(projectcss.all, sty.svg__h22Lk, {
              [sty.svgexpanded__h22LkNb1EE]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
