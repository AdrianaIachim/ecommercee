...
import sty from "./PlasmicProfilo.module.css"; // plasmic-import: nme1wKp3UWMlns/css
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: TDOAy6gLZgM9SS/icon
import photo14387616810336461Ffad8D80JpgYjnBicfcDBtYtT from "./images/photo14387616810336461Ffad8D80Jpg.jpg"; // plasmic-import: yjnBicfcDBtYtT/picture
    ...
    <React.Fragment>
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__k3YRe)}>
              <p.PlasmicImg
                ...
                loading={"lazy"}
                src={{
                  src: photo14387616810336461Ffad8D80JpgYjnBicfcDBtYtT,
                  fullWidth: 1000,
                  fullHeight: 667,
            ...
            <div className={classNames(projectcss.all, sty.column___3KKId)}>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___0EbN)}
              >
                <h2
                ...
                <div className={classNames(projectcss.all, sty.freeBox__u8CyZ)}>
                  {true ? (
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__tULrr)}
                    >
                      <input
                  ...
                  >
                    {false ? (
                      <Icon4Icon
                        className={classNames(projectcss.all, sty.svg__cKetn)}
                        role={"img"}
                      />
                    ) : null}
                    <div
                    ...
                    {false ? (
                      <Icon4Icon
                        className={classNames(projectcss.all, sty.svg__wjb9G)}
                        role={"img"}
                      />
                    ) : null}
                  </p.Stack>
